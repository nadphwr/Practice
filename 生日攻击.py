# -*- coding: utf-8 -*-
"""
Created on Sun Jul 24 14:46:31 2022
...
if __name__ == '__main__':
    ...
    #生成消息空间
    massage_space=range(9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999)
    for i in massage_space:
        m_a=Fill(str(i))
        M_a=Group(m_a)
        Vn_a=Iterate(M_a)
        result_attack=''
        for j in Vn_a:
            result_attack+=(hex(j)[2:]+' ')
        if result_attack==result:
            print(i)
            break